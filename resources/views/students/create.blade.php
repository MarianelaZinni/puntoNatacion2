    ...
    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">La edad se calcula automáticamente según la fecha de nacimiento</p>
            ...
            <div>
                ...
                <input
                    ...
                    type="month"
                    required
                    value="{{ old('active_from', now()->format('Y-m')) }}"
                ...
                >
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Mes y año a partir del cual el alumno estará activo y comenzará a generar deuda.</p>
                @error('active_from')

<x-layouts.app title="Crear nuevo método de pago">
    <div class="max-w-3xl mx-auto py-8 px-4">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Nuevo Método de Pago</h1>
        </div>
        ...
        <form action="{{ route('payment_methods.store') }}" method="POST" id="payment-method-form" class="space-y-8 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-lg p-6 shadow-sm">
            @csrf

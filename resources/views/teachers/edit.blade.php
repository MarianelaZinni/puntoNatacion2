<x-layouts.app title="Editar profesor">
    <div class="max-w-3xl mx-auto py-8 px-4">
        ...
        <form action="{{ route('teachers.update', $teacher) }}" method="POST" class="space-y-8 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-lg p-6 shadow-sm">
            @csrf
            @method('PUT')

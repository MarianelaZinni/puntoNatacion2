<x-layouts.app title="Nuevo Profesor">
    <div class="max-w-3xl mx-auto py-8 px-4">
        ...
        <form action="{{ route('teachers.store') }}" method="POST" id="teacher-form" class="space-y-8 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-lg p-6 shadow-sm">
            @csrf
